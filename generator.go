...
`, form.Name, form.Title, max(320, form.Width), max(240, form.Height), max(0, form.Padding), form.Name, main.Name, generatedFormCallbacks(form, 2), form.Name)
	}
...
%s`, generatedMarker, imports, assetSupport, setup.String(), main.Title, max(320, main.Width), max(240, main.Height), max(0, main.Padding), main.Name, generatedFormCallbacks(main, 2), main.Name, builders.String(), themes.String())
}
